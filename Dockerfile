...
#
#FROM openjdk:11
#COPY --from=compile target/StockPortfolioManager-0.0.1-SNAPSHOT.jar app.jar
#EXPOSE 8080
...
COPY --from=compile /usr/src/mymaven/target/StockPortfolioManager-0.0.1-SNAPSHOT.jar app.jar
